...
const Carousel1 = () => {
    return (
        <div className="h-96 sm:h-96 xl:h-96 2xl:h-96 ">
            ...
            <Carousel slideInterval={4000} data-bs-touch="false">
                ...
                <Image loading="eager" width={450} height={200}  className="object-contain 2xl:h-96 h-96 w-full" src="https://dev-cs55-13-2023.pantheonsite.io/wp-content/uploads/2023/12/14c.webp" alt="orange juice" />
